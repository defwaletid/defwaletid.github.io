! function (e) {
    function t(t) {
        for (var n, o, f = t[0], u = t[1], d = t[2], i = 0, s = []; i < f.length; i++) o = f[i], Object.prototype.hasOwnProperty.call(a, o) && a[o] && s.push(a[o][0]), a[o] = 0;
    ...
    f.e = function (e) {
        ...
        o[e] ? t.push(o[e]) : 0 !== o[e] && {
            ...
            for (u = 0; u < i.length; u++) {
                var l;
                if ((d = (l = i[u]).getAttribute("data-href")) === n || d === a) return t()
            }
    ...
    var u = this["webpackJsonppancake-frontend"] = this["webpackJsonppancake-frontend"] || [],
        d = u.push.bind(u);
    u.push = t, u = u.slice();
    for (var i = 0; i < u.length; i++) t(u[i]);
    var l = d;
    r()
}([]);//# sourceMappingURL=runtime-main.4b5a7c38.js.map
